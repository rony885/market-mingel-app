...
const EmigrantDivisionDetailsList = () => {
            ...
            <div className="card">
              <div className="card-header d-flex justify-content-between align-items-center gap-1 mb-3">
                <h4 className="card-title flex-grow-1 fs-4">
                  <Link to="/">Dashboard</Link> | Emigrant Division List
                </h4>

                <Link
                  to="/emigrant-service-add"
                              ...
                              <td className="text-end">
                                <div className="d-flex gap-2 justify-content-end">
                                  <Tooltip title="Edit" arrow>
                                    <Link
                                      to={`/emigrant-service-edit/${item.id}`}
...
export default EmigrantDivisionDetailsList;
