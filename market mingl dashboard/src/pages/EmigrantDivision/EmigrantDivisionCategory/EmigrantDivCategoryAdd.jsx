...
const EmigrantDivCategoryAdd = () => {
  ...
  const AddCategoryFunc = async (values) => {
    ...
    await axios({
      method: "POST",
      url: `${process.env.REACT_APP_BASE_URL}/emigrantService_api/unpaginate_emigrantService_category/`,
      data: formfield,
    })
      .then((response) => {
...
export default EmigrantDivCategoryAdd;
