...
const ClientEdit = () => {
  ...
  const UpdateServiceFunc = async (values) => {
    ...
    await axios({
      method: "PATCH",
      url: `${process.env.REACT_APP_BASE_URL}/client_api/unpaginate_client/${item.id}/`,
      data: formfield,
    })
      .then((response) => {
  ...
  useEffect(() => {
    const updateCategory = async (id) => {
      const { data } = await axios.get(
        `${process.env.REACT_APP_BASE_URL}/client_api/unpaginate_client/${id}/`
      );
      setItem(data);
                      ...
                      <div className="p-3  my-3 rounded">
                        <div className="row justify-content-end g-2">
                          <div className="col-lg-2">
                            ...
                            >
                              {isSubmitting ? "Submitting..." : " Edit Client"}
                            </button>
                          </div>
                          <div className="col-lg-2">
                            <button
